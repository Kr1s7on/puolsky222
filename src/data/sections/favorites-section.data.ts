...
const favoritesSectionData = {
  ...
  medias: {
    ...
    data: [
      {
        image: import('@/assets/favorites/media/tldr.jpg'),
        title: 'TLDR AI',
        type: 'Newsletter',
        url: 'https://tldr.tech/',
      },
      ...
      {
        image: import('@/assets/favorites/media/lauriewired_final.jpg'),
        title: 'LaurieWired',
        type: 'Researcher',
        url: 'https://lauriewired.com/',
      },
      {
        image: import('@/assets/favorites/media/goto_logo.jpg'),
        title: 'goto;',
        type: 'Youtube Channel',
        url: 'https://www.youtube.com/gotoconferences',
      },
    ],
  },
